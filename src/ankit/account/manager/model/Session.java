package ankit.account.manager.model;

import org.json.JSONObject;

import android.content.Context;
import ankit.account.manager.completionhandler.Callback;
import ankit.account.manager.completionhandler.RequestJSONCallback;
import ankit.account.manager.exception.SessionException;
import ankit.account.manager.service.Service;
import ankit.account.manager.util.AccountUtils;
import ankit.account.manager.util.Preferences;
